export const articlesNews = [
  ...
  },
  {
    ...
    bubbleTextTwo: 'Asst. Professor  ',
    bubbleTextThree: 'Asad Madni',
    articleHeadlineOne:'',
    articleHeadlineTwo:'Prof. Madni Receives IEEE Award, Hid Rattan and Canadian Academy of Enginering',
    articleHeadlineThree: ' ',
    articleImage1: '/2020-2021/img/Madni_Canadian_Academy_Eng.jpg',
    articleImage2:'/2020-2021/img/madni_pravasi_bharatiya_divas.jpg',
    ...
    articleImageAltText5: '',
    articleImageAltText6: '',
    articleImageMain: '/2020-2021/img/Madni_Canadian_Academy_Eng.jpg',
    articleImageAltTextMain: 'Asad Madni',
    articleImageProf: '/2020-2021/img/Madni_Canadian_Academy_Eng.jpg',
    articleImageAltTextProf: 'Asad Madni',
    articleImageCred: '',
    articleCaption1: 'Asad Madni honored by Canadian Academy of Engineer, IEEE Sensor Council and "Jewel of India" Award',
    articleCaption2: '',
    articleCaption3: '',
    articleAuthor: 'Asad Madni',
    textCopy: '  <p style="text-indent:0;"><span class="first-letter"> Our </span> Asad Madni as been elected as an International Fellow of the Canadian Academy of Engineering. Madni was one of only two international fellows selected this year.</p><p>     The Canadian Academy of Engineering (CAE) is an institution through which individuals, who have made outstanding contributions to engineering in the country, provide strategic advice on matters of critical importance to Canada and its citizens. Established in 1987, CAE Fellows are “nominated and elected by their peers in view of their distinguished achievements and career-long service.”</p><p>   <h3>IEEE Sensors Council Advanced Technical Achievement Award    </h3><p> Distinguished Adjunct Professor Asad M Madni was awarded the prestigious 2021 IEEE Sensors Council\‘s Advanced Technical Achievement Award in the area of Sensor Systems and Networks “for seminal contributions to the development and commercialization of electronic sensors, systems and instrumentation for aerospace and automotive safety”. The award will be presented at the 2021 IEEE Sensors Conference to be held in Sydney, Australia from October 31st through November 4th. </p><p>The IEEE Sensors Council hopes to serve the sensor community with new publications, conferences, and technical committees. Its fields of interest and activities are the theory, design, fabrication, manufacturing, and application of devices for sensing and transducing physical, chemical, and biological phenomena, with emphasis on the electronics and physics aspects of sensors and integrated sensor-actuators. The IEEE Sensors Council publishes  IEEE Sensors Journal, IEEE Internet of Things Journal and  IEEE Sensors Letters<p></p><h3>Jewel of India </h3>    <p>Professor Madni was awarded the Hind Rattan ("Jewel of India") Award, one of the highest Indian diasporic awards granted annually to non-resident persons of Indian origin (NRIs) by the NRI Welfare Society of India. His award citation reads “for outstanding Services, Achievements and Contributions” The award is granted at the Society’s annual congress on the eve of India\'s Republic Day, in conjunction with national Pravasi Bharatiya Divas (Non-Resident Indian Day) celebrations. The award ceremony is attended by senior members of the Government of India and of the Supreme Court of India. The number of awardees varies each year, but is generally about 25. Prof. Madni was awarded the Hind Rattan in 2018, however, due to schedule conflicts, and then Covid 19 lockdown, he finally accepted the award in a virtual ceremony.</p><p> Professor  Madni received his bachelor’s and master’s degrees in engineering from UCLA and a doctoral degree from California Coast University. He developed and commercialized sensors, systems and instrumentation for the automotive, industrial and aerospace industries. As president, chief operating officer and chief technology officer of BEI Technologies, he developed the Extremely Slow Motion Servo Control System for the Hubble Space Telescope and the Quartz MEMS GyroChip technology used in stability control and rollover protection in automobiles. Madni also led major scientific research at Ryerson University in Toronto, and has been a doctoral thesis advisor to many prominent Canadians.</p><p>   Madni has been elected a fellow or an eminent member by some of the world’s most prestigious scientific and technical academies and societies. Among them are the National Academy of Engineering, National Academy of Inventors, Royal Academy of Engineering, European Academy of Sciences and Arts, New York Academy of Sciences, American Association for the Advancement of Science, Institute of Electrical and Electronics Engineers, Institution of Engineering and Technology, American Institute of Aeronautics and Astronautics, Society of Automotive Engineers, American Institute of Medical and Biological Engineering and the Royal Aeronautical Society. He received the UCLA Samueli Alumnus of the Year in 2004.</p><p>    In 2019, IEEE Eta Kappa Nu established a new annual award in his name. Madni has been awarded five honorary doctoral degrees and six honorary professorships. </p>'
  },
  {
    articleId: 'jia-ming',
    bubbleTextOne: 'Distinguished ',
